...
public class GlideRoundedCornersTransform extends CenterCrop {
    ...
    public GlideRoundedCornersTransform(Context context, float radius, CornerType cornerType) {
        super();
        mRadius = DisplayUtil.dip2px(radius);//dp ->px
    ...
    public boolean equals(Object o) {
        if(o instanceof GlideRoundedCornersTransform){
            GlideRoundedCornersTransform other = (GlideRoundedCornersTransform)o;
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) {
        ...
        messageDigest.digest(radiusData);
    }
}

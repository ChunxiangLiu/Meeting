...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = BaseAppApplication.Companion.getInstance().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = BaseAppApplication.Companion.getInstance().getResources().getDisplayMetrics().scaledDensity;

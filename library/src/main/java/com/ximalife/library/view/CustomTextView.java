...
/**
 * CustomTextView   xmlns:app="http://schemas.android.com/apk/res-auto"
 */
...
//        int solid = a.getColor(R.styleable.customTextView_textSolidColor, Color.TRANSPARENT);
     ...
     */
    public void setStrokeColorAndWidth(int colorId) {
        setStrokeColorAndWidth(strokeWidth, colorId);
    }
    ...
    public void setStrokeColorAndWidth(int strokeWidth, int colorId) {
        normalGD.setStroke(strokeWidth, colorId);
        setBackgroundDrawable(normalGD);
    }

...
public class CustomRoundAngleGridImageView extends AppCompatImageView {
    ...
    public CustomRoundAngleGridImageView(Context context) {
        this(context, null);
        init(context, null);
    }

    public CustomRoundAngleGridImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public CustomRoundAngleGridImageView(Context context, AttributeSet attrs, int defStyleAttr) {

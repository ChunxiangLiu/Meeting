...
public class BottomNavigationItem {
    ...
    private String lottieresource;

    private boolean openLottie = false;
    ...
    public BottomNavigationItem(String lottieresource, @NonNull String mTitle) {
    ...
    public BottomNavigationItem setActiveIconResource(@DrawableRes int mIconResource) {
        this.mIconResource = mIconResource;
        return this;
    }

    public BottomNavigationItem setLottieResource(String lottieResource) {
        this.lottieresource = lottieResource;
        return this;
    }
    ...
    /**
     * 设置开启lottie动画 需要设置json文件不然默认设置选中非选中图片
     *
     * @param flag
     * @return
     */
    public BottomNavigationItem setOpenLottie(boolean flag) {
        this.openLottie = flag;
        return this;
    }
    ...
    public String getLottieresource() {
        return lottieresource;
    }

    public boolean isOpenLottie() {
        return openLottie;
    }

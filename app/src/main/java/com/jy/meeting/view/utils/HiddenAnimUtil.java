...
public class HiddenAnimUtil {
     ...
     */
    public static HiddenAnimUtil newInstance(Context context, View hideView, View down, int height) {
        return new HiddenAnimUtil(context, hideView, down, height);
    }

    private HiddenAnimUtil(Context context, View hideView, View down, int height) {

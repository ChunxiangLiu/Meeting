package com.jy.selectphoto.util;
...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = BaseAppApplication.application.getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = BaseAppApplication.application.getResources().getDisplayMetrics().scaledDensity;
